...
<div style="padding: 20px; display: none" id="df">
        ...
        <div class="layui-form-item" style="display: table-cell; width: 50%">
            ...
            <div class="layui-input-block">
                <input type="text" name="nickname" id="nickname" placeholder="请输入用户姓名"
                       autocomplete="off" class="layui-input" lay-verify="required">
            </div>
        </div>
        <br>
        <div class="layui-form-item" style="display: table-cell; width: 50%">
            ...
            <div class="layui-input-block">
                <input type="text" name="sex" id="sex" placeholder="请输入用户电话"
                       autocomplete="off" class="layui-input" lay-verify="required">
            </div>
        </div>
        <br>
        <div class="layui-form-item" style="display: table-cell; width: 50%">
            ...
            <div class="layui-input-block">
                <input type="text" name="first" id="first" placeholder="请输入身份证"
                       autocomplete="off" class="layui-input" lay-verify="required">
            </div>
        </div>
        <br><br>
        <div class="layui-form-item" id="bu3" style="margin-left: 210px">
            <div class="layui-btn-group">
                <button class="layui-btn" onclick="gbi()" lay-filter="update_submit" >关&ensp;闭</button>
